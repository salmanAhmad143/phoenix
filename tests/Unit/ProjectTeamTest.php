...
class ProjectTeamTest extends TestCase
{
    public function testIndex()
    {
        ...
        $response = $this->json('GET', 'http://phoenix.localhost/api/v1/project/team', $data, $auth);
    ...
    public function testStore()
    {
        ...
        $response = $this->json('POST', 'http://phoenix.localhost/api/v1/project/team/add', $data, $auth);
        $response->assertStatus(200);
        $response->assertJson([
            "success" => true,
    ...
    public function testDestroy()
    {
        ...
        $response = $this->json('DELETE', 'http://phoenix.localhost/api/v1/project/team/remove', $data, $auth);
        $response->assertStatus(200);
        $response->assertJson([
            "success" => true,
