...
class CodeMasterController extends Controller
{
    ...
    public function __construct(CodeMasterRepositoryInterface $codeMasterRepository)
    {
    ...
    {
        try {
            if(isset($request->codeType)) {
                $requestParam['codeType'] = $request->codeType;
                $rslt = $this->codeMasterRepository->getCodeMaster($requestParam);
            }
