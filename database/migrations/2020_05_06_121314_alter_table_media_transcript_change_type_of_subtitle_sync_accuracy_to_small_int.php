...
class AlterTableMediaTranscriptChangeTypeOfSubtitleSyncAccuracyToSmallInt extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::table('media_transcript', function (Blueprint $table) {
            $table->unsignedSmallInteger('subtitleSyncAccuracy')->after('maxCharsPerSecond')->nullable();
        });
    }
