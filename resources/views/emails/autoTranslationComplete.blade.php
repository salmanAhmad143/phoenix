                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        ...
                                                        <tr>
                                                            <td align="center" class="textContent" valign="top">
                                                                ...
                                                                <h2 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Auto Translation Ready</h2>
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" style="max-width: 100%;">
                                                                    ...
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            ...
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#5F5F5F;line-height:135%;">Auto translation ready for {{$mediaName}}.</div>
